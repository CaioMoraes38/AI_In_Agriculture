...
METRICS_PATH = os.path.join(PROJECT_ROOT, "src", "models", "visionModel", "vision_model_metrics.json")
HISTORY_PATH = os.path.join(PROJECT_ROOT, "src", "models", "visionModel", "training_history.pkl")
GRAPHICS_PATH = os.path.join(PROJECT_ROOT, "src", "graphics", "vision")
...
def generate_model_summary_chart(metrics):
    ...
    for info in model_info:
        ax.text(0.1, y_pos, f"• {info}", fontsize=11, transform=ax.transAxes, family='monospace')
        y_pos -= 0.15
    ...
    print("✓ Gráfico salvo: 05_resumo_modelo.png")
    plt.close()
...
def generate_learning_curves(history):
    ...
    print("✓ Gráfico salvo: 06_curvas_aprendizado.png")
    plt.close()
...
def generate_class_distribution():
    ...
    ax.set_title('Distribuição de Classes no Dataset (Simulado)', fontsize=14, fontweight='bold')
    ...
    print("✓ Gráfico salvo: 07_distribuicao_classes.png")
    plt.close()

def generate_prediction_comparison():
    print("\n📈 Gerando comparação de predições...")
    fig, axes = plt.subplots(2, 5, figsize=(16, 8))
    fig.suptitle('Exemplos de Predições por Classe', fontsize=14, fontweight='bold')
    ...
    print("✓ Gráfico salvo: 08_exemplos_classes.png")
    plt.close()

def generate_performance_metrics():
    print("\n📈 Gerando métricas de desempenho gerais...")
    fig, axes = plt.subplots(1, 2, figsize=(14, 5))
    fig.suptitle('Métricas de Desempenho Adicionais', fontsize=14, fontweight='bold')
    ...
    ax.set_title('Métricas de Classificação (Simulado)', fontsize=12, fontweight='bold')
    ax.set_ylim([0, 1])
    ...
    print("✓ Gráfico salvo: 09_metricas_desempenho.png")
    plt.close()
...
def generate_inference_speed():
    ...
    ax.set_xlabel('Tamanho do Lote (Batch Size)', fontsize=12, fontweight='bold')
    ax.set_ylabel('Tempo (segundos)', fontsize=12, fontweight='bold')
    ax.set_title('Velocidade de Inferência vs Tamanho do Lote (Simulado)', fontsize=14, fontweight='bold')
    ax.grid(True, alpha=0.3)
    ...
    print("✓ Gráfico salvo: 10_velocidade_inferencia.png")
    plt.close()
...
def main():
    ...
    print("   - 05_resumo_modelo.png")
    print("   - 06_curvas_aprendizado.png")
    print("   - 07_distribuicao_classes.png")
    print("   - 08_exemplos_classes.png")
    print("   - 09_metricas_desempenho.png")
    print("   - 10_velocidade_inferencia.png\n")
